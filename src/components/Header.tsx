    ...
    return (
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="https://aradbranding.com/" className="flex items-center">
                    <Image width={35} height={35} src="/arad-icon.png" className="h-8 mr-3" alt="Arad Branding Logo" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Arad Branding</span>
                </a>
